...
public class ColorSchemes {
    ...
    public static final String[] SCHEME_NAMES = new String[] {"Default", "Paired", "C64", "Hello Kitty", "Dark", "Dark 2", "Blues", "GitHub", "Solarized (light)", "Solarized (dark)"};
